  ...
  @Component({
    selector: 'app-addservicepage',
    templateUrl: './addservicepage.component.html',
    styleUrls: ['./addservicepage.component.scss']
  })
  export class AddservicepageComponent implements OnInit {
    ...
    public sendform(result){
      ...
      this.repository.postFile('addservicepage',formData).subscribe(res=>{
        this.result = res;
        alert('add new page!')
      },   (error => {
